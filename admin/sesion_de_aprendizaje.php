                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tr>
                          ...
                          <th colspan="2"><center>INFORMACIÓN GENERAL</center></th>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                          ...
                          <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <textarea name="logro_sesion" id="" cols="200" rows="2"><?php echo $r_b_sesion['logro_sesion']; ?></textarea>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr>
                                    <th colspan="4"><center>Secuencia Didáctica</center></th>
                                </tr>
                                <tr>
                                    <th><center>Momentos</center></th>
                                    <th><center>Estrategias y actividades</center></th>
                                    <th><center>Recursos didácticos</center></th>
                                    <th><center>Tiempo (minutos)</center></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr>
                                    <th colspan="5"><center>ACTIVIDADES DE EVALUACIÓN</center></th>
                                </tr>
                                <tr>
                                    <th width="30%"><center>INDICADORES DE LOGRO DE SESIÓN</center></th>
                                    <th width="15%"><center>TÉCNICAS</center></th>
                                    <th width="25%"><center>INSTRUMENTOS</center></th>
                                    <th width="15%"><center>PESO O PORCENTAJE</center></th>
                                    <th width="15%"><center>MOMENTO</center></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr>
                                    <th colspan="2"><center>BIBLIOGRAFÍA</center></th>
                                </tr>
                                <tr>
                                    <th width="50%"><center>PARA EL DOCENTE</center></th>
                                    <th width="50%"><center>PARA EL ESTUDIANTE</center></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <thead>
                                    <tr>
                                        <th colspan="2"><center>ANEXOS</center></tr></th>
                                </thead>
                                    <tr>
                                        <td colspan="2">
