...
if ($enviar) {
    ...
    try {
        ...
        //Recipients
        $mail->setFrom($r_b_datos_sistema['email_email'], 'SISPA '.$r_b_datos_sistema['titulo']);
        ...
        $mail->send();
        //echo 'Correo enviado';
        $sql = "UPDATE docente SET reset_password=1, token_password='$token' WHERE id=$id_persona";
