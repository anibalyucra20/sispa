                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        <thead>
                            <tr>
                                <th colspan="5"><center>ORGANIZACIÓN DE ACTIVIDADES Y CONTENIDOS BÁSICOS</center></th>
                            </tr>
                            <tr>
                                <th><center>Semana/Fecha</center></th>
                                <th><center>Elemento de Capacidad</center></th>
                                <th><center>Actividades Aprendizaje</center></th>
                                <th><center>Contenidos Básicos</center></th>
                                <th><center>Tareas Previas</center></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            while ($r_b_act_silabo = mysqli_fetch_array($b_act_silabo)) {
                                ?>
                                <tr>
                                    <td><center><?php echo $r_b_act_silabo['semana']."<br>"; ?><input type="date" name="fecha_<?php echo $r_b_act_silabo['id'];?>" value="<?php echo $r_b_act_silabo['fecha'];?>"></center></td>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        <thead>
                            <tr>
                                <th colspan="2" width="100%"><center>ESTRATEGÍAS DE EVALUACIÓN</center></th>
                            </tr>
                            <tr>
                                    <th width="50%"><center>INDICADORES</center></th>
                                    <th width="50%"><center>TÉCNICAS (Instrimentos)</center></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
