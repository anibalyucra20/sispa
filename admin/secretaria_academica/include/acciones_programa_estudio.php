                  ...
                  <div class="x_content">
                    ...
                    <form role="form" action="operaciones/actualizar_programa_estudio.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea class="form-control"  rows="3" style="width: 100%; min-height: 165px; height: auto;" name="perfil_egreso" required="required"><?php echo $res_busc_carrera['perfil_egresado']; ?></textarea>
                          <br>
                          <br>
                        </div>
                      </div>
